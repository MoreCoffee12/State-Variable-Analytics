...
' =============================================================================
' Function Name:  VBShowHfo_mx_SI
' Name: VBShowHfo_mx_SI
' Purpose: Retrieves the enthalpy of formation in SI units, J/gmol, for mixture
'          as either a double value or an error string based on the error priority
'          and tolerance. It serves as a wrapper for the ShowHfo_mx_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Precision: Double, solver precision
...
'
' Returns:
' - Double: enthalpy calculated in SI units, J/gmol
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowHfo_mx_SI function and handles its return values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 9 Oct 2023, Upgraded to 64-bit code
' =============================================================================
...
' =============================================================================
' Function Name:  VBShowHfo_mx_USCS
' Name: VBShowHfo_mx_USCS
' Purpose: Retrieves the enthalpy of formation in USCS units, BTU/lbmol, for mixture
'          as either a double value or an error string based on the error priority
'          and tolerance. It serves as a wrapper for the ShowHfo_mx_USCS DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Precision: Double, solver precision
...
'
' Returns:
' - Double: enthalpy calculated in USCS units, BTU/lbmol
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowHfo_mx_USCS function and handles its return values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 9 Oct 2023, Upgraded to 64-bit code
...
' =============================================================================
' Function Name:  VBShowH_H298_SI
' Name: VBShowH_H298_SI
' Purpose: Retrieves the ideal gas enthalpy in SI units, kJ/kg, based on the
'   JANAF tables, relative to 298 Kelvin. as either a double value or an error
'   string based on the error priority and tolerance. It serves as a wrapper
'   for the ShowH_H298_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Temperature: Double, temperature in SI units, kelvin
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowH_H298_SI function and handles its return
'   values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 8 Oct 2023, Upgraded to 64-bit code
' =============================================================================
...
' =============================================================================
' Function Name:  VBShowH_H298_USCS
' Name: VBShowH_H298_USCS
' Purpose: Retrieves the ideal gas enthalpy in USCS units, BTU/lbm, based on the
'   JANAF tables, relative to 298 Kelvin. as either a double value or an error
'   string based on the error priority and tolerance. It serves as a wrapper
'   for the ShowH_H298_SI DLL function.
'
...
'
' Returns:
' - Double: enthalpy calculated in USCS units, BTU/lbm
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowH_H298_USCS function and handles its return
'   values and errors
'
' Author: Brian Howard
' Date: 2001
...
' =============================================================================
' Function Name:  VBShowHIdeal_SI
' Name: VBShowHIdeal_SI
' Purpose: Retrieves the ideal gas enthalpy in SI units, kJ/kg, as either a double value or
'           an error string based on the error priority and tolerance. It serves as
'           a wrapper for the ShowHIdeal_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Temperature: Double, temperature in SI units, kelvin
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowHIdeal_SI function and handles its return
'   values and errors
'
' Author: Brian Howard
' Date: 2001
...
' =============================================================================
' Function Name:  VBShowHIdeal_USCS
' Name: VBShowHIdeal_USCS
' Purpose: Retrieves the ideal gas enthalpy in USCS units, BTU/lbm, as either a
'   double value or an error string based on the error priority and tolerance.
'   It serves as a wrapper for the ShowHIdeal_USCS DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Temperature: Double, temperature in USCS units, Rankine
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowHIdeal_USCS function and handles its return
' - values and errors.
'
' Author: Brian Howard
' Date: 2001
...
'
' =============================================================================
' Function Name:  VBShowT_HP_SI
' Name: VBShowT_HP_SI
' Purpose: Retrieves the temperature in SI units, kelvin, for a given
'          enthalpy and pressure and returns it as either a double value or
'          an error string based on the error priority and tolerance.
'          It serves as a wrapper for the ShowT_HP_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Enthalpy: Double, enthalpy in SI units, kJ/kg
' - Pressure: Double, temperature in SI units, bar
' - Precision: Double, solver precision
' - MaxIterations: Double, maximum number of solver iterations
' - PercentMethane, PercentEthane, ..., PercentSilane: Doubles, percent composition of
'       each component in the mixture.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowT_HP_SI function and handles its return values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 30 Sep 2023, Upgraded to 64-bit code
...
' =============================================================================
' Function Name:  VBShowV_TP_SI
' Name: VBShowV_TP_SI
' Purpose: Retrieves the specific volume in SI units, (cm3/kg). for a given
'          temperature and pressure and returns it as either a double value or
'          an error string based on the error priority and tolerance.
'          It serves as a wrapper for the ShowV_TP_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Temperature: Double, temperature in SI units, kelving
...
'
' Returns:
' - Double: Specific volume calculated in SI units, (cm3/kg)
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowV_TP_SI function and handles its return values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 30 Sep 2023, Upgraded to 64-bit code
...
'
' =============================================================================
' Function Name:  VBShowSatVapH_P_SI
' Name: VBShowSatVapH_P_SI
' Purpose: Retrieves the saturated vapor enthalpy in SI units, kJ/kg, for a given
'          pressure and returns it as either a double value or
'          an error string based on the error priority and tolerance.
'          It serves as a wrapper for the ShowSatVapH_P_SI DLL function.
'
' Parameters:
' - eosset: Integer, Equation of State Set
' - Pressure: Double, pressure in SI units, bar(a)
...
'
' Returns:
' - Double: Entropy calculated in SI units, kJ/kg
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Notes:
' - Error tolerance can be adjusted through the ErrTolerance variable
' - The function relies on the ShowSatVapH_P_SI function and handles its return values and errors
'
' Author: Brian Howard
' Date: 2001
' Revision: 30 Sep 2023, Upgraded to 64-bit code
...
' =============================================================================
' Function Name:  VBShowViscosityGas_TP_SI
' Name: VBShowViscosityGas_TP_SI
' Purpose: Returns the gas absolute viscosity at in SI units, kg/m-sec, given the
'           mixture temperture and pressure and returns it as either a double value or
'          an error string based on the error priority and tolerance.
'          It serves as a wrapper for the ShowSatVapS_P_SI DLL function.
'
' Parameters:
...
'
' Returns:
' - Double: Absolute viscosity in SI units, uPoise
' - String: Error line if the error priority is within the defined tolerance
'
' Error Handling:
' The function has built-in error handling which returns the error number and description.
...
' Author: Brian Howard
' Date: 2001
' Revision: 3 Jan 2024, Upgraded to 64-bit code
' =============================================================================
