...
Declare Function ShowDipole_USCS _
    Lib "GasAnalysis.dll" (ByVal fluidindex As Integer, _
...
End Function
Function VBShowName(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowName_Alt01(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowFormula(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowMolWeight(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritTemp_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritTemp_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritPres_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritPres_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritVol_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowCritVol_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowEcc(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowR_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowHfo_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowHfo_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowSfo_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowSfo_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowHHV_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowHHV_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowLHV_SI(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowLHV_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowDipole_USCS(fluidindex As Integer, ErrTolerance As Integer)
...
Function VBShowDipole_SI(fluidindex As Integer, ErrTolerance As Integer)
