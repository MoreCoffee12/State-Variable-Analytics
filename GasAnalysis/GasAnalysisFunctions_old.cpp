 ...
 * fluid.											*
 ****************************************************/
int ShowName( double fluidindex, char *textline,
					double *priority01,
					char *mainerrline01)
{
	//local variables
	...
	errs			= 0;
	peosline		= bwrs.GetName( (int)fluidindex );
	pmerrline		= NULL;
	i				= 0;

	//transfer the to the argument
	strcpy( textline, peosline );
	...
	if( errs > 0 )
	{
		...
		strcpy( mainerrline01, pmerrline );
...
//---------------------------------------------------------------------------
// The next few functions use the BWRS equation of state
//---------------------------------------------------------------------------
 ...
 * specific volume and temperature					*
 ****************************************************/
int ShowV_TP_USCS( double eosset, 
						double temp,
						double pres,
						double *MixtureArray,
						double Precision,
