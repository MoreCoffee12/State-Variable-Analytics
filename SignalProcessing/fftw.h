...
extern fftw_plan __cdecl fftw_create_plan(int n, fftw_direction dir, int flags);
extern void fftw_print_plan(fftw_plan plan);
extern void __cdecl fftw_destroy_plan(fftw_plan plan);
extern void __cdecl fftw(fftw_plan plan, int howmany, fftw_complex *in, int istride,
		 int idist, fftw_complex *out, int ostride, int odist);
extern void __cdecl fftw_one(fftw_plan plan, fftw_complex *in, fftw_complex *out);
